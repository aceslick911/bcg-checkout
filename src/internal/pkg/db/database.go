...
import (
	...
	"github.com/aceslick911/bcg-checkout/internal/pkg/models/basket_items"
	"github.com/aceslick911/bcg-checkout/internal/pkg/models/baskets"
...
func migration() {
	...
	DB.AutoMigrate(&baskets.Basket{})
	DB.AutoMigrate(&basket_items.Basket_Item{})
}
